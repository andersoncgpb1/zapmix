...
Para publicar uma versão com auto-update no GitHub, envie estes arquivos para a release:

- `ZapMix-Setup-1.0.7.exe`
- `ZapMix-Setup-1.0.7.exe.blockmap`
- `latest.yml`
...
- `server.js` - servidor Express, WhatsApp, APIs e Socket.IO.
- `public/index.html` - moderação.
- `public/config.html` - configurações.
- `public/enquete.html` - painel da enquete.
- `public/enquete-exibidor.html` - exibidor da enquete.
- `public/sorteio.html` - painel do sorteio.
- `public/sorteio-exibidor.html` - exibidor do sorteio.
- `public/exibidor.html` - exibidor de mensagens.
