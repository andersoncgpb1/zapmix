  ...
  try {
    ...
    try {
      ...
      return {
        ...
        error: "Servidor retornou resposta inválida: " + text.substring(0, 120)
      };
    }
    ...
    if (!response.ok || !data.ok) {
      return {
        ...
        error: data.error || data.erro || "Licença inválida"
      };
    }
    ...
    return {
      ok: false,
      status: "SEM_CONEXAO",
      error: "Erro ao validar licença: " + err.message
    };
  }
}
